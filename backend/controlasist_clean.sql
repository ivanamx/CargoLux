...
ALTER TABLE IF EXISTS ONLY public.project_locations DROP CONSTRAINT IF EXISTS project_locations_project_id_fkey;
ALTER TABLE IF EXISTS ONLY public.project_equipment DROP CONSTRAINT IF EXISTS project_equipment_project_id_fkey;
...
ALTER TABLE IF EXISTS ONLY public.location_history DROP CONSTRAINT IF EXISTS location_history_attendance_id_fkey;
DROP INDEX IF EXISTS public.ix_vacation_history_id;
DROP INDEX IF EXISTS public.ix_users_username;
DROP INDEX IF EXISTS public.ix_users_id;
DROP INDEX IF EXISTS public.ix_users_email;
DROP INDEX IF EXISTS public.ix_time_entries_id;
DROP INDEX IF EXISTS public.ix_projects_id;
DROP INDEX IF EXISTS public.ix_project_locations_id;
DROP INDEX IF EXISTS public.ix_project_equipment_id;
DROP INDEX IF EXISTS public.ix_project_documents_id;
DROP INDEX IF EXISTS public.ix_project_assignments_id;
DROP INDEX IF EXISTS public.ix_performance_evaluations_id;
DROP INDEX IF EXISTS public.ix_notifications_id;
DROP INDEX IF EXISTS public.ix_location_history_id;
DROP INDEX IF EXISTS public.ix_companies_name;
DROP INDEX IF EXISTS public.ix_companies_id;
DROP INDEX IF EXISTS public.ix_certifications_id;
DROP INDEX IF EXISTS public.ix_attendances_id;
ALTER TABLE IF EXISTS ONLY public.vacation_history DROP CONSTRAINT IF EXISTS vacation_history_pkey;
...
ALTER TABLE IF EXISTS ONLY public.project_locations DROP CONSTRAINT IF EXISTS project_locations_pkey;
ALTER TABLE IF EXISTS ONLY public.project_equipment DROP CONSTRAINT IF EXISTS project_equipment_pkey;
...
ALTER TABLE IF EXISTS ONLY public.performance_evaluations DROP CONSTRAINT IF EXISTS performance_evaluations_pkey;
...
ALTER TABLE IF EXISTS public.vacation_history ALTER COLUMN id DROP DEFAULT;
...
ALTER TABLE IF EXISTS public.project_locations ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.project_equipment ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.project_documents ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.project_assignments ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.performance_evaluations ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.notifications ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.location_history ALTER COLUMN id DROP DEFAULT;
...
DROP SEQUENCE IF EXISTS public.vacation_history_id_seq;
DROP TABLE IF EXISTS public.vacation_history;
...
DROP SEQUENCE IF EXISTS public.project_locations_id_seq;
DROP TABLE IF EXISTS public.project_locations;
DROP SEQUENCE IF EXISTS public.project_equipment_id_seq;
DROP TABLE IF EXISTS public.project_equipment;
DROP SEQUENCE IF EXISTS public.project_documents_id_seq;
...
DROP SEQUENCE IF EXISTS public.performance_evaluations_id_seq;
DROP TABLE IF EXISTS public.performance_evaluations;
DROP SEQUENCE IF EXISTS public.notifications_id_seq;
DROP TABLE IF EXISTS public.notifications;
DROP SEQUENCE IF EXISTS public.location_history_id_seq;
